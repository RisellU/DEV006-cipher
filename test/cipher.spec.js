...
describe('cipher', () => {
  ...
  describe('cipher.encode', () => {
    ...
    it('test do encode minusculas for "daniel" return "ifsnjq" with offset 5', () => {
      expect(cipher.encode("daniel", 5)).toMatch(/ifsnjq/);
    })
    
    it('test do not encode caracteres especiales for ".,!/-$" return ".,!/-$" with offset 33', () => {
      expect(cipher.encode(".,!/-$", 33)).toEqual(".,!/-$");
    })
  ...
  describe('cipher.decode', () => {
    ...
    it('test do decode minusculas for "ifsnjq" return "daniel" with offset 5', () => {
      expect(cipher.decode("ifsnjq", 5)).toMatch(/daniel/);
    
    });

    it('test do not encode caracteres especiales for ".,!/-$" return ".,!/-$" with offset 33', () => {
      expect(cipher.decode(".,!/-$", 33)).toEqual(".,!/-$");
    });
  })})
